...
class Concat(nn.Module):
    ...
    def __init__(self, in_feat_dims, out_channels, dropout_rate=0):
        ...
        self.fc1 = nn.Linear(in_feat_dims, out_channels // 2, bias=True)
        self.fc2 = nn.Linear(in_feat_dims, out_channels // 2, bias=True)
        self.relu = nn.ReLU()

    def __call__(self, x, y):
        return self.relu(torch.cat((self.fc1(x), self.fc1(y)), -1))
